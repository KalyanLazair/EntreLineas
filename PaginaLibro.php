...
<div class="contenedorPerfil row" style="background-color: #10707f">
    <div class="col-4 border border-dark">
        <div class="row border border-dark">
            <div class="col-2"></div>
            <div class="col-8 border border-dark" style="height:400px; width:150px; background-color: #80bdff">
        ...
        <div class="row border border-dark" style="background-color: #efa2a9">
            ...
            <br/>
             <button id="mLibro" class="btn btn-primary btn-block" type="button">Modificar</button>
        </div>
    </div>
